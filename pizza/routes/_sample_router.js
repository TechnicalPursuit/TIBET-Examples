...
(function(root) {
    ...
    module.exports = function(options) {
        ...
        logger.system(
            ...
            TDS.colorize('POST /sample/forminput', 'route'));
        ...
        /*
         test via curl using variations (adjust port etc) of:
            ...
            curl -XPOST http://127.0.0.1:1407/sample/forminput \
                --header "Content-Type: application/json" \
                --data "@../mocks/mockjson_post.json"

            curl -XPOST -k https://127.0.0.1:1443/sample/forminput \
                --header "Content-Type: application/json" \
                --data "@../mocks/mockjson_post.json"
         */
        ...
        //  automatically app.use('sample', router) on startup.
        return router;
    };
